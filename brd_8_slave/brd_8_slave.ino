...
led_message relayboard_8; //Her board için değişltirlecek
...
memcpy(&relayboard_8, data, sizeof(relayboard_8));

  RelayState=relayboard_8.State;
...
void setup() {
    ...
    initWiFi();
    initEspNow();
    myData.id=8; // her board için değiştirilecek
    digitalWrite(5,1);
