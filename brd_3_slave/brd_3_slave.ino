...
led_message relayboard_3; //Her board için değişltirlecek
...
memcpy(&relayboard_3, data, sizeof(relayboard_3));

  RelayState=relayboard_3.State;
...
void setup() {
    ...
    initWiFi();
    initEspNow();
    myData.id=3; // her board için değiştirilecek
    digitalWrite(5,1);
