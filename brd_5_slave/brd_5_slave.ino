...
led_message relayboard_5; //Her board için değişltirlecek
...
memcpy(&relayboard_5, data, sizeof(relayboard_5));

  RelayState=relayboard_5.State;
...
void setup() {
    ...
    initWiFi();
    initEspNow();
    myData.id=5; // her board için değiştirilecek
    digitalWrite(5,1);
