...
led_message relayboard_10; //Her board için değişltirlecek
...
memcpy(&relayboard_10, data, sizeof(relayboard_10));

  RelayState=relayboard_10.State;
...
void setup() {
    ...
    initWiFi();
    initEspNow();
    myData.id=10; // her board için değiştirilecek
    digitalWrite(5,1);
