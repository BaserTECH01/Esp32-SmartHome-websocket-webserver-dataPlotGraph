...
led_message relayboard_7; //Her board için değişltirlecek
...
memcpy(&relayboard_7, data, sizeof(relayboard_7));

  RelayState=relayboard_7.State;
...
void setup() {
    ...
    initWiFi();
    initEspNow();
    myData.id=7; // her board için değiştirilecek
    digitalWrite(5,1);
