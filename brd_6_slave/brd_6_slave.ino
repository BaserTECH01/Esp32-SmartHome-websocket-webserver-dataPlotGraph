...
led_message relayboard_6; //Her board için değişltirlecek
...
memcpy(&relayboard_6, data, sizeof(relayboard_6));

  RelayState=relayboard_6.State;
...
void setup() {
    ...
    initWiFi();
    initEspNow();
    myData.id=6; // her board için değiştirilecek
    digitalWrite(5,1);
